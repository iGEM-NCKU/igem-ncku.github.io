<template>
    ...
    <v-row justify = end>
        <v-col cols = 12 md = 7 class = 'pa-5'>
            <v-img style="margin-bottom: -8%; margin-top: -7%;" src = "https://static.igem.wiki/teams/6003/title/8.avif"/>  
