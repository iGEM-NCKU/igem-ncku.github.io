        ...
        <v-main>
            ...
            <v-row justify="end">
                <v-col cols="12" md="8" class="pa-5">
                            ...
                            <v-row justify="center" class="mt-8">
                                <v-col cols="12" sm="6" md="5" class="text-center">
                                    ...
                                    >
                                        ...
                                        <v-card-title class="text-h4 mb-3">Biofilm Prediction Tool</v-card-title>
                    ...
                    <!-- Biofilm Prediction Tool Section -->
                    <div id="Biofilm-Prediction-Tool" class="section-container scroller">
                                        ...
                                        <v-card :variant="alpha.card.theme" class="text-box pa-5">
                                            <div class="text-content">
                                                ...
                                                <v-alert type="info" class="mb-4">
                                                    ...
                                                    <a href="https://johan-susilo.github.io/biofilm-ml-model/" target="_blank" class="text-decoration-none">
                                                        https://johan-susilo.github.io/biofilm-ml-model/
                                                    </a>
                                                </v-alert>
                                            </div>
                                        </v-card>
...
/* Navigation styling for biofilm and endzyme sections */
.biofilm-nav .v-chip,
.endzyme-nav .v-chip {
  margin: 2px 4px;
